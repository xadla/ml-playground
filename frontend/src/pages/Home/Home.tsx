  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Draw datasets, train models, and see results instantly."
        />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Draw your dataset on an interactive canvas, choose an algorithm, and watch your
                model learn in real time. No code needed.
              </p>
