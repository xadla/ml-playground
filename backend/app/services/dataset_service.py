...
BUILTIN_DATASETS: list[dict[str, Any]] = [
    {
        ...
        "description": "Classic dataset for classifying iris flowers into 3 species based on sepal and petal measurements. Perfect for beginners learning classification.",
        "row_count": 150,
        "column_names": [
            "sepal_length",
            "sepal_width",
    ...
    },
    {
        ...
        "description": "Predict passenger survival on the Titanic based on demographics, ticket class, and other features. A great introduction to binary classification.",
        "row_count": 891,
        "column_names": [
            "passenger_id",
            "survived",
    ...
    {
        "id": "builtin_heart_disease",
        "name": "Heart Disease UCI",
        "description": "Predict presence of heart disease based on clinical parameters. Great for medical ML applications.",
        "row_count": 1025,
        "column_names": [
            "age",
            "sex",
